...
Follow these instructions to set up the software that we'll be using throughout the semester. **Even if you've already downloaded both R and RStudio for past classes/projects, you'll want to update your software to the most current versions.**
...
- **FIRST:** Download R [here](https://cran.rstudio.com/).
    ...
    - As of August 27, 2025, the latest version of R is 4.5.1.
- **SECOND:** Download RStudio [here](https://posit.co/download/rstudio-desktop/#download).
    ...
    - As of August 27, 2025, the latest version of RStudio is 2025.05.1+513.
