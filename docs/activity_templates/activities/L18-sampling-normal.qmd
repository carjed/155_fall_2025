...
<!-- - Depending upon timing, you might change some chunks to have blanks for students to fill in. I provided all code here. -->
<!-- - I put some Normal review in the Exercises: Review section. I didn't come across many similar problems in peoples' notes, so remove if you'd like. I have more questions here if this seems too short: https://ajohns24.github.io/155_Spring_2022/normal-model-random-samples.html -->
<!-- - The exercises ask students to fill out a survey. The google form is in our shared STAT 155 materials: https://drive.google.com/drive/folders/1XsSRQdXr80Z5iz_JWk-MkqUiRATtBZmI?usp=drive_link -->
...
#| echo: false
#| eval: true
make_student_notes('The Normal model & sampling variation', '_L18-sampling-normal.qmd')
```
...
{{< include core/_L18-sampling-normal.qmd >}}
