# Multiple linear regression: model building (part 2)
...
#| echo: false
#| eval: true
make_student_notes('Multiple linear regression: model building (part 2)', '_L14-mlr-model-building-2.qmd')
```
...
{{< include core/_L14-mlr-model-building-2.qmd >}}
