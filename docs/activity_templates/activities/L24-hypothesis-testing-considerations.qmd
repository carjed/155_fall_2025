...
#| echo: false
#| eval: true
make_student_notes('Hypothesis testing: additional considerations', '_L24-hypothesis-testing-considerations.qmd')
```
...
{{< include core/_L24-hypothesis-testing-considerations.qmd >}}
