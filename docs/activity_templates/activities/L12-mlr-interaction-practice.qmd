# Multiple linear regression: interaction terms practice
...
#| echo: false
#| eval: true
make_student_notes('Multiple linear regression: interaction terms practice', '_L12-mlr-interaction-practice.qmd')
```
...
{{< include core/_L12-mlr-interaction-practice.qmd >}}
