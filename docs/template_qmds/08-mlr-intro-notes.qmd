...
### If you're early(ish): Find your nametag at the front, and if it's there, bring the rest of the nametags in the stack to a table

### If your nametag isn't at the front, find the table where it is

-   PP1 scores/feedback have been posted on Moodle; PP2 will be up soon
...
-   **Quiz 1 on Thursday!**
    ...
    -   studying
        ...
        -   Review in-class activities + solutions, checkpoints, and homework feedback

        -   Review slides from Ryan's review session (sent via email)

        -   Visit office hours to clarify concepts

            -   Extra office hours added today after class

        -   check out [Professor Johnson's study tips](https://ajohns24.github.io/155_Fall_2025/activities/99-appendix.html)
    ...
    -   structure
        ...
        -   students with extra time accommodations CAN take the quiz in class if you want, and use the extra 30 minutes

    -   content

        -   Everything we have covered up through last Thursday (Categorical predictors).

        -   It will not include questions about transformations (which was covered in an optional checkpoint/activity) or multiple linear regression (today!)

        -   you will not need to write R code, but will need to read & interpret R output

    -   Materials

        -   you can use a 3x5 index card with writing on both sides.
            These can be handwritten or typed, but you may *not* include screenshots or share note cards – making your own card is important to the review process.
            You are required to hand this in with your quiz.

        -   you cannot use and will not need to use a calculator

    -   there will be limited opportunities for revision (you can earn up to 50% of missed points back).
        Review syllabus for details.
