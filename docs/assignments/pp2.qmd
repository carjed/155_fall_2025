...
- More practice fitting simple linear regression models
...
## OPTIONAL Exercise 5: Thinking about transformations

This exercise will not be graded. However, you're encouraged to try it!
